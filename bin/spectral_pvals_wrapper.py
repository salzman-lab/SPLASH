...
def main():
    ...
    for f_seq in itertools.product(['A','T','C','G'],repeat=3):
        f_seq = "".join(f_seq)
        command = """python /oak/stanford/groups/horence/tavorb/stringstats_tavor/stringstats/bin/compute_spectral_pvals.py --outfile_scores {}/int_pvals_{}.tsv --samplesheet {} --infile {}/abundant_stratified_{}.txt.gz""".format(args.intermediate_fldr,f_seq
        ,args.samplesheet,
